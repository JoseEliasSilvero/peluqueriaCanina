...
public class Principal extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        CargaDatos pantalla = new CargaDatos(); //creamos la instancia
        pantalla.setVisible(true);          //mostramos la pantalla
        pantalla.setLocationRelativeTo(null); //centra en el medio cuando abre la pantalla 
